...
export const fetchFood = () => {
  return (dispatch) => {
    return axios
      .get("https://c459-46-183-103-8.eu.ngrok.io/api/food")
      .then((res) => {
...
export const addFoodToFridge = (userId, foodIdToAdd) => {
  return (dispatch) => {
    return axios({
      method: "put",
      url: "https://c459-46-183-103-8.eu.ngrok.io/api/user/addfood/" + userId,
      data: { foodIdToAdd },
    })
      .then((res) => {
...
export const removeFoodFromFridge = (userId, foodIdToRemove) => {
  return (dispatch) => {
    return axios({
      method: "put",
      url:
        "https://c459-46-183-103-8.eu.ngrok.io/api/user/removefood/" + userId,
      data: { foodIdToRemove },
    })
      .then((res) => {
        dispatch({
